...
var DBG = {
  ...
  CONFIG               : {
    ...
    MODULES    : {} // will hold the configuration for the logger module (cf. getLogger(module))
  },
...
function getLogger ( module ) {
  ...
  Object.keys(DBG.TAG).forEach(function ( prop ) {
    logger[prop.toLowerCase()] = function () {
      ...
      if (DBG.CONFIG.MODULES[module] != false) {
...
function debugFactory () {
  ...
  DBG.setModuleConfig = function setModuleConfig ( module, bool_flag) {
    DBG.CONFIG.MODULES[module] = bool_flag;
    return setModuleConfig; // for chaining
  };
